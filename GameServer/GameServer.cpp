...
int main()
{
    ...
    ASSERT_CRASH(GDBConnectionPool->Connect(1, L"Driver={SQL Server Native Client 11.0};Server=(localdb)\\ProjectModels;Database=master;Trusted_Connection=Yes;Connect Timeout=30;"));
